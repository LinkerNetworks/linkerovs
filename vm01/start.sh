...
ethtool -G ens2f1 rx 4096
ethtool -G ens2f1 tx 4096
...
$DPDK_DIR/tools/dpdk_nic_bind.py --bind=igb_uio ens2f1
...
iptables -t nat -A POSTROUTING -o enp11s0f0 -j MASQUERADE
iptables -t nat -A POSTROUTING -o br0 -j MASQUERADE

ifconfig br0 192.168.200.1/24
ip link set br0 up
